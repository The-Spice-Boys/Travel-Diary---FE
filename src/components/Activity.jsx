...
const MyVerticallyCenteredModal = ({ activity, show, onHide, userId }) => {
  ...
  return (
    <Modal
      ...
      centered
    >
      <Modal.Header closeButton style={{ backgroundColor: '#eff4f3' }}>
        <Modal.Title id="contained-modal-title-vcenter">{title}</Modal.Title>
      </Modal.Header>
      <Modal.Body style={{ backgroundColor: '#eff4f3' }}>
        ...
        {addPhotoButton && (
          <div className="mb-3">
            ...
            {isPhotoCreated && (
              <div
                className={`justify-content-between text-success-emphasis align-items-center mt-3 fade show`}
              >
                New photo has been uploaded successfully !
              </div>
            )}
          </div>
        )}
      ...
      {loggedInUser.userId === userId && (
        <Modal.Footer style={{ backgroundColor: '#eff4f3' }}>
          <MdAddAPhoto
            className="icon-color react-icon"
