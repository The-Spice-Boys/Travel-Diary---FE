...
import { getItinerariesByUserId, getUserBioByUsername, getUserByUsername } from "../api.js";
...
export const UserPage = () => {
  ...
  return (
    ...
    <div class="container-fluid mt-5 mb-2">
      <h2>Profile</h2>
      <figure class="figure">
        <img src={profile_pic_url} class="figure-img img-fluid rounded" alt={username}/>
      </figure>
      <p>{bio}</p>
